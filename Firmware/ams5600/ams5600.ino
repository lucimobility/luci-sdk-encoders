...
byte buf[25] = {'+', 'A', 'R', ' ', 'N', 'C', 'D', 'R', '=', 0, 0, 0, 0,
...
void loop()
{
    // If the encoder loses the magnet it will send 0.0 for that wheel angle reading
    ...
    // degree
     ...
     {
         leftWheelAng =
             long(convertRawAngleToDegrees(encoder.getRawAngle()) * 100);
     }
